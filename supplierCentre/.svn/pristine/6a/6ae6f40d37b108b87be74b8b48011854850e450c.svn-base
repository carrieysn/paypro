...
public class PreSupplier implements Serializable{
	...
	private String active_code;//产品活动码
	private String title;//产品标题
	private String desc1;//产品描述
	private String pic_detail_info;//产品详情
	private String pic_url;//商品链接
	...
	private BigDecimal service_fee;//服务费
	...
	private String biz_remark;//商家备注
	...
	private String areaPath;//省市区
	private String detailPath;//地区详细地址
	...
	public void setSettled_price(BigDecimal settled_price) {
		if(null == settled_price){
			this.settled_price = new BigDecimal(0);
		}else{
		   this.settled_price = settled_price;
		}
	}
	public BigDecimal getDiscount_price() {
		if(null == discount_price){
			return  new BigDecimal(0);
		}else{
	...
	public void setDiscount_price(BigDecimal discount_price) {
		if(null == discount_price){
			this.discount_price = new BigDecimal(0);
		}else{
	...
	public String getBiz_remark() {
		if(StringUtil.isEmpty(biz_remark)){
			return "";
		}else{
		    return biz_remark;
		}
	...
	public String getIntroducerTel() {
		if(StringUtil.isEmpty(introducerTel)){
			return "";
		}else{
