...
public class Constant extends CommonConstant {
	...
	static {
		...
		HOLIDAY_MAP.put("2017-05-28", "端午节");
		HOLIDAY_MAP.put("2017-05-29", "端午节");
		HOLIDAY_MAP.put("2017-05-30", "端午节");
		HOLIDAY_MAP.put("2017-10-01", "国庆节");
		HOLIDAY_MAP.put("2017-10-02", "国庆节");
		HOLIDAY_MAP.put("2017-10-03", "国庆节");
		HOLIDAY_MAP.put("2017-10-04", "中秋节");
		HOLIDAY_MAP.put("2017-10-05", "中秋节");
		HOLIDAY_MAP.put("2017-10-06", "中秋节");
